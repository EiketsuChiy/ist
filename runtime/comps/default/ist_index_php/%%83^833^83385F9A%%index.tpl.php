<?php /* Smarty version 2.6.18, created on 2017-03-14 10:42:22
...
unset($_smarty_tpl_vars);
 ?>
<div class="macbook" style="background-color:#F0F0F0">
	<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="400px" height="300px" viewBox="0 0 694.1 384" enable-background="new 0 0 400 300">	
...
<div class="jumbotron">
  ...
  <br>
  <p>欢迎进入信软科技工作室</p>
  <p><a class="btn btn-info btn-lg" href="<?php echo $this->_tpl_vars['url']; ?>
/profile" role="button">了解更多</a></p>
</div>
